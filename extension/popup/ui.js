...
// Tab definitions
const TABS = [
    { id: 'videos-tab', label: 'Videos', isDefault: true },
    { id: 'downloads-tab', label: 'Downloads' },
...
function createTabNavigation() {
    ...
    TABS.forEach(tab => {
        ...
        if (tab.id === 'videos-tab' || tab.id === 'downloads-tab') {
...
export function updateTabCounter(uiTabId) {
    if (uiTabId === 'videos-tab') {
        ...
        const counter = document.querySelector(`#${uiTabId} .tab-counter`);
...
export async function initializeUI() {
    ...
    return {
        container: tabContents.querySelector('#videos-tab'),
        clearCacheButton,
        themeToggle,
        tabContents,
        switchTab
